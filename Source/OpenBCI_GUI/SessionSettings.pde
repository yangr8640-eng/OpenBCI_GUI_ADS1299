...
class SessionSettings {
    ...
    private void loadApplyWidgetDropdownText() {
        ...
        if (currentBoard instanceof AccelerometerCapableBoard && w_accelerometer != null) {
    ...
    String getPath(String _mode, int dataSource, int _nchan) {
        ...
        if (!filePath.equals("Error")) {
            ...
            } else if (dataSource == DATASOURCE_ADS129X) {
