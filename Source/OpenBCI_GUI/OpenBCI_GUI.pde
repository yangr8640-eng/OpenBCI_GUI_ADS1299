...
final int DATASOURCE_ADS129X = 6;
...
void initSystem() {
    ...
    switch (eegDataSource) {
        ...
        case DATASOURCE_STREAMING:
            ...
            break;
        case DATASOURCE_ADS129X:
            currentBoard = new BoardADS129xTcp(
                    controlPanel.ads129xConfigBox.getListenPort(),
                    controlPanel.ads129xConfigBox.getSampleRate()
                    );
            println("OpenBCI_GUI: Init session using ADS1299 16ch WiFi TCP data source");
            break;
        default:
            break;
    }
